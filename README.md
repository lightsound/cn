...
| ---------- | -------------- | --------- | -------------- |
| 2 strings  | 20.76 ns       | 31.14 ns  | **33% faster** |
| 3 strings  | 51.51 ns       | 63.86 ns  | **19% faster** |
| 5 strings  | 65.85 ns       | 83.50 ns  | **21% faster** |
| 10 strings | 107.87 ns      | 135.43 ns | **20% faster** |
