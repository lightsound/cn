...
- **Blazing Fast**: Up to 35% faster than `clsx/lite`
...
| ---------- | -------------- | --------- | -------------- |
| 2 strings  | 20.63 ns       | 31.82 ns  | **35% faster** |
| 3 strings  | 52.22 ns       | 66.93 ns  | **22% faster** |
| 5 strings  | 66.90 ns       | 86.22 ns  | **22% faster** |
| 10 strings | 103.22 ns      | 145.93 ns | **29% faster** |
