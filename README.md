...
| --------- | -------------- | --------- | ----------- |
| 2 strings | 37.02 ns | 48.97 ns | **24% faster** |
| 3 strings | 36.85 ns | 54.44 ns | **32% faster** |
| 5 strings | 55.60 ns | 65.09 ns | **15% faster** |
| 10 strings | 89.93 ns | 110.16 ns | **18% faster** |
<!-- BENCHMARK_END -->
