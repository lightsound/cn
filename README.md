...
| --------- | -------------- | --------- | ----------- |
| 2 strings | 98.40 ns | 95.68 ns | **-3% faster** |
| 3 strings | 90.04 ns | 102.36 ns | **12% faster** |
| 5 strings | 92.96 ns | 118.85 ns | **22% faster** |
| 10 strings | 159.04 ns | 185.23 ns | **14% faster** |
<!-- BENCHMARK_END -->
