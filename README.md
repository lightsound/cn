...
| --------- | -------------- | --------- | ----------- |
| 2 strings | 83.02 ns | 75.29 ns | **-10% faster** |
| 3 strings | 99.67 ns | 107.45 ns | **7% faster** |
| 5 strings | 81.65 ns | 105.11 ns | **22% faster** |
| 10 strings | 144.94 ns | 163.36 ns | **11% faster** |
<!-- BENCHMARK_END -->
