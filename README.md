...
- **Blazing Fast**: Up to 27% faster than `clsx/lite`
...
| --------- | -------------- | --------- | ----------- |
| 2 strings | 82.68 ns | 74.80 ns | **-11% faster** |
| 3 strings | 99.63 ns | 113.56 ns | **12% faster** |
| 5 strings | 111.99 ns | 153.47 ns | **27% faster** |
| 10 strings | 181.74 ns | 199.71 ns | **9% faster** |
<!-- BENCHMARK_END -->
